...
wine <- read.table("C:/Users/Usuario/Desktop/Shiny/wine.csv", header=TRUE, sep=";", as.is=TRUE, na.strings="?")
wine <- na.omit(wine)
wine <- wine[1:100,]
# Scaling
...
server <- function(input, output) {
    output$distPlot <- renderPlot({
        ...
        datos<-read.csv("C:/Users/Usuario/Desktop/Shiny/wine.csv",sep=";")
        datos<-datos[1:100,]
        #x    <- faithful[, 2]
    ...
    output$distPlottt <- renderPlot({
        swine<- read.csv("C:/Users/Usuario/Desktop/Shiny/wine.csv", header = TRUE, sep = ";") 
